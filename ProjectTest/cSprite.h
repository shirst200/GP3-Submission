...
public:
	...
	void updateAnimated(int noAlong,int noUp);							// update the position etc of the sprite
	void setBoundingRect(RECT* pRect);		// Determine the bounding rectangle for the sprite
	void setBoundingAnimatedRect(RECT* pRect,int noAlong,int noUp);		// Determine the bounding rectangle for the sprite
